...
void bewegen(HWND hwnd)
{
    ...
    for (t = 0; t <= t_max; t = t + t_step)
    {
        ...
        {
            sprintf(wtext, "Robbi[0]:  Pos.: x = %3.2lf, y = %3.2lf; Gesamtzeit:  %.2lf s",
                    Robbi[0].arm_2.Armn[Robbi[0].arm_2.anz_p - 1][0], Robbi[0].arm_2.Armn[Robbi[0].arm_2.anz_p - 1][1],
                    gesamtzeit / 1000);
        }
        else
        {
        ...
        // Das Programm wird t-step lang gestoppt. Wenn man davon ausgeht, dass die Rechenzeit gegen Null geht, kann man an dieser Stelle auch die Gesamtzeit mit t_step hochzaehlen
    } // for t..
    ...
    /////////// folgende Zeilen nur zur Demo, dass sich mehrere Roboter gleichzeitig bewegen können (hier Robbi[2 pendelt hin und her auf horizontal zur x-Achse] gleichzeitig bewegen können
