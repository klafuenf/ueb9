//-------------------------------------------------------------------------------------------------------------------
// Programm zur Ermittlung von notwendigen Winkeln eines SCARA-Roboters Erweiterung von scara_w.c, so dass die Arme nicht springen (auf der Basis des Cosinus-Satzes)
// Autor: Julian Gaiser /MBB3C
// Datum 27.12.10
// basiert auf den Konventionen von SCARA-Modell.doc
// Programmname SuchenWinkel
// Eingaben
// double sollpunkt[2], 				double l1, double l2, double alpha1[2],double alpha2[2]
// double sollpunkt[2]:					Adresse der x,y Koordinaten des Roboterendrehpunktes bezogen auf den Ursprungshiftpunkt (0,0) !!!
// double l1, double l2					Länge der Arme 1 und 2 (Abstand zwischen Ursprung(Px.6) und Endrehpunkt (Px.7)
// double alpha1[2],double alpha2[2])	Adresse der Winkelstellungen von Arm1 und Arm2 gegenüber der Senkrechten
